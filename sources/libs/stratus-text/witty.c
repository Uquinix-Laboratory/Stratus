...
static char *_witty[] = {
    ...
    "Hi. I'm STRATUS, and I'm a crashaholic.",
    ...
    "Let me interject for a moment, what you call errors are in fact stratus/errors",
    "Make it a feature",
    "Minecraft crashed!",
    "My bad.",
    ...
    "One day stratus will be bug free :tm:",
    "OOF!",
    "OoooOOoOoOF!",
    "Oops.",
    "PC LOAD LETTER",
...
static char const *_nice[] = {
    ...
    "This is why STRATUS is called the unix utopia",
    "VICTORY ROYALE",
    "Well hello friends :^)",
